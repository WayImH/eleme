<template>
    <div class="confirmOrderContainer">
            ...
            <mt-header title="确认订单" fixed>
			  ...
			  <router-link to="/chooseAddress" slot="right" v-if="$store.state.userName">
		...
		<section >
            <a @click="useryn()" class="address_container">
                <div class="address_empty_left">
                    <img src="../../static/dingwei.svg"/>
            ...
            <section class="delivery_model container_style  waimai">
...
export default {
	data(){
		return {
			...
			goodsList:this.$store.state.shopCar.goodsList
		}
	},
	computed:{
		choose(){
...
height: 2rem;
 ...
 .waimai p{font-size: 0.8rem; font-style: normal;}
...
.popup .popup-list > div .btn-right {
	...
	.mint-header { height: 2rem; font-size: .7rem;}
	.mint-header-title { overflow: visible;}
	.mint-header .mintui { font-size: 0.8rem;}
