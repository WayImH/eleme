    ...
    <div class="address_page">
        ...
        <section class="page_text_container">
            ...
            <section class="section_list">
                ...
                <section class="section_right">
                    <div class="phone_add">
                        <input type="text" name="phone" placeholder="你的手机号" v-model="obj.phone" class="input_style">
                    </div>
                </section>
            </section>
            <section class="section_list">
                ...
                <section class="section_right">
                	<input type="text" v-model="obj.address" name="address_detail" placeholder="详细地址（如门牌号等）" class="input_style">
                </section>
            </section>
            <section class="section_list">
                <span class="section_left">标签</span>
                <section class="section_right">
                    <input type="text" name="tag" v-model="obj.tag" placeholder="无/家/学校/公司" class="input_style">
                </section>
            </section>
        </section>
